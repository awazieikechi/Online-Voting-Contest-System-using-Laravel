@extends('layouts.layout_auth_admin_contest')
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-0 h3">Create Account to Participate </h1>
                        </div>
                        <form method="POST" action="{{ route('register') }}" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter your Name" id="name" name="name" value="{{old('name')}}" autofocus required>
                                    @error('name')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="example@xyc.com" id="email" name="email" value="{{old('email')}}" autofocus required>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
